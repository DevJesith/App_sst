// features/forms/gestion/presentation/screens/gestion_detalle_screen.dart
...
class GestionDetalleScreen extends StatelessWidget {
              ...
              child: Column(
                children: [
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      _buildInfoRow('Proyecto', gestion.proyecto),
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      _buildInfoRow(
                        'Extintor Máquina',
                        gestion.extintorMaquina,
                      ),
                      _buildInfoRow(
                        'Rutinaria Máquina',
                        gestion.rutinariaMaquina,
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(
                            gestion.gestionCumple.toLowerCase() == 'sí' ||
                                    gestion.gestionCumple.toLowerCase() == 'si'
                                ? Icons.check_circle
                                : Icons.cancel,
                            color:
                                gestion.gestionCumple.toLowerCase() == 'sí' ||
                          ...
                          Expanded(
                            child: Text(
                              gestion.gestionCumple.toLowerCase() == 'sí' ||
                                      gestion.gestionCumple.toLowerCase() ==
                                          'si'
